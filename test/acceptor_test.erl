...
-define(INITIAL_STATE, #state{ready_to_gc=[]}).
-define(ADD_ONE_ELECTION(E), acceptor_statestore:add(E)).
...
should_not_change_state_when_receiving_lower_prepare_request() ->
    ...
    {1, CurrentElection} = acceptor_statestore:find(1),
...
%%
%% -- TODO: Needs updating to use acceptor_statestore instead of lists
%%
